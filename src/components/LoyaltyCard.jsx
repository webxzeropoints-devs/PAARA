...
export default function LoyaltyCard({ stampsCount = 0, animateStamps = false, stampAnimationDelay = 0, newestStampIndex = 0 }) {
              ...
              {Array.from({ length: 6 }, (_, index) => {
                ...
                return (
                  <motion.div
                    ...
                    initial={animateStamps && stamped && index + 1 === Number(newestStampIndex) ? { scale: 0 } : false}
                    animate={animateStamps && stamped && index + 1 === Number(newestStampIndex) ? { scale: [0, 1.15, 1] } : { scale: 1 }}
                    transition={animateStamps && stamped && index + 1 === Number(newestStampIndex) ? { delay: stampAnimationDelay, duration: .42, ease: [0.22, 1.2, .36, 1] } : undefined}
