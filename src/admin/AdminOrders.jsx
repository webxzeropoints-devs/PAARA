          ...
          <tbody>
            {orders.map((order) => {
              ...
              return <tr key={order.id} className="border-b border-cocoa/10 align-top odd:bg-sand/35">
                <td className="min-w-0 break-words px-3 py-4 text-cocoa"><p className="break-words font-semibold">{order.order_number || `ORD-${order.id}`}</p><p className="mt-1 text-[10px] uppercase tracking-widest text-cocoa/50">Customer #{order.customer_id}</p></td>
                <td className="min-w-0 px-3 py-4"><p className="truncate text-cocoa" title={order.customer_name}>{order.customer_name}</p><p className="truncate text-xs text-cocoa/50" title={order.customer_email}>{order.customer_email}</p></td>
                <td className="min-w-0 break-words px-3 py-4 text-xs leading-relaxed text-cocoa/75">
                ...
                <td className={`min-w-0 px-3 py-4 text-cocoa/75 ${isRejected ? "text-red-700" : ""}`}>
