...
function CustomerLove() {
  ...
  return <section className="relative overflow-hidden bg-[#efe4d2] bg-[url('/assets/img.png')] bg-cover bg-center bg-no-repeat py-24 md:py-28"><div className="absolute inset-0 bg-[#efe4d2]/35" /><span className="absolute text-6xl left-[8%] top-10 opacity-50">🐚</span><span className="absolute text-4xl right-[12%] top-16 opacity-50">✦</span><span className="absolute text-5xl right-[7%] bottom-8 opacity-50">♡</span><span className="absolute text-3xl left-[18%] bottom-10 opacity-50">●</span><div className="relative z-10 text-center px-6"><p className="text-xs uppercase tracking-[.3em] text-gold">Notes from our community</p><span className="heading-wave-wrap"><h2 className="font-display text-4xl mt-3">Customer Love</h2><HeadingWave className="mt-3" /></span></div><div className="relative z-10 love-marquee mt-12"><div className="love-track">{[...notes, ...notes].map((note, index) => <article key={index} className="relative w-[310px] md:w-[390px] aspect-[1398/1118] shrink-0"><div className="absolute inset-[2%_4%] overflow-hidden [clip-path:ellipse(46%_48%_at_50%_50%)]"><img src="/assets/img.png" alt="" aria-hidden="true" className="absolute left-[-27%] top-[-18%] h-[136%] w-[154%] max-w-none object-cover object-center" /></div><div className="relative z-10 flex h-full flex-col items-center justify-start px-[19%] pt-[30%] text-center"><span className="text-gold">✦</span><p className="mt-3 text-xl md:text-2xl leading-snug text-cocoa">{note}</p><p className="mt-4 text-[10px] tracking-[.2em] uppercase text-cocoa/60">Paara. customer</p></div></article>)}</div></div></section>;
}
