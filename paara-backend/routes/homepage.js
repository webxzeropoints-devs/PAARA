...
router.get('/worn-by-you',(req,res)=>res.json(db.prepare('SELECT id,instagram_post_url,image_url,caption,likes FROM instagram_reviews WHERE product_id IS NULL ORDER BY cached_at ASC,id ASC LIMIT 3').all()));
